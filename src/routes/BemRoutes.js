...
router
    ...
    .post("/bens/adicionar",  AuthMiddleware, BemController.adicionarBem) // Adiciona um bem a tabela bem adcicionados
    .post("/bens/auditar",  AuthMiddleware, BemController.auditarBem) // audita um bem
